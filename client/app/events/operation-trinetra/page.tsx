        ...
        <div className="container mx-auto px-6 py-20">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="https://unstop.com/p/operation-trinetra-hack-for-defense-systems-ceg-guindy-1544492" target="_blank" rel="noopener noreferrer">
                <Button size="lg" className="bg-purple-600 hover:bg-purple-700 text-white px-8 py-3 font-semibold">
                  Register Now
                </Button>
              </Link>
              <Link href="/contact">
